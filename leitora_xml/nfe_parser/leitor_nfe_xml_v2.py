        ...
        try:
            ...
            if ibscbs is not None:
                ...
                if gibscbs is not None:
                    ...
                    for field_key, xml_tag in ibscbs_fields.items():
                        value = self.find_element_text(gibscbs, xml_tag)
                        if value:
                            item_data[field_key] = self._to_float(value)
...
if __name__ == "__main__":
    ...
    if not df.empty:
        ...
        print(f"\n ARQUIVOS EXPORTADOS:")
        print(f"   Excel: {excel_file} (com 4 abas organizadas)")
